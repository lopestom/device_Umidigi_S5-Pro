...
DEVICE_PATH := device/umidigi/S5_Pro_EEA
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 227363803072
BOARD_USERDATAIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_VENDORIMAGE_PARTITION_SIZE := 664195072
...
# Dynamic Partition
BOARD_SUPER_PARTITION_SIZE := 10093173145
BOARD_SUPER_PARTITION_GROUPS := qti_dynamic_partitions
BOARD_QTI_DYNAMIC_PARTITIONS_SIZE := 10093173145
...
TARGET_OTA_ASSERT_DEVICE := S5 Pro,S5_Pro,UMIDIGI_S5_Pro,S5_Pro_EEA
BOARD_CHARGER_DISABLE_INIT_BLANK := true
TW_EXCLUDE_DEFAULT_USB_INIT := true
TW_EXTRA_LANGUAGES := true
TW_INCLUDE_NTFS_3G := true
TW_USE_TOOLBOX := true
TW_DEVICE_VERSION := -1 by lopestom
TW_DEFAULT_DEVICE_NAME := S5_Pro_EEA
